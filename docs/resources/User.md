...
| avatar_decoration_data? | ?[avatar decoration data](#DOCS_RESOURCES_USER/avatar-decoration-data-object) object  | the user's [avatar decoration data](#DOCS_RESOURCES_USER/avatar-decoration-data-object)              | identify              |
...
The user's avatar decoration object.

###### Avatar Decoration Data Structure

| Field  | Type    | Description                                                           |
|--------|---------|-----------------------------------------------------------------------|
| asset  | string  | the user's [avatar decoration hash](#DOCS_REFERENCE/image-formatting) |
| sku_id | string  | the sku of the avatar decoration in the Discord collectible shop      |
